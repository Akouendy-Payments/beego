...
// GetAll ...
// @Title Get All
// @Description get BillingTransaction
...
// @Success 200 {object} models.BillingTransaction
// @Failure 403
// @router / [get]
func (c *BillingTransactionController) GetAll() {
	...
	*/
	l, err := models.GetAllBillingTransaction(query, fields, sortby, order, offset, limit)
	if err != nil {
